 ...
 * routes (#35). `api_keys` is deliberately not RLS-protected like the
 * tenant-scoped tables (see schema.ts) — looking a key up is what
 * *establishes* org context, so it can't already be scoped by it.
 */
